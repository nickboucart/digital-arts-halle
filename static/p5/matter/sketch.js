...
function preload() {
  ...
  handPose = ml5.handPose({maxHands: 1, flipped: true, modelType: 'lite', detectorModelUrl: '/handpose-detector/model.json', landmarkModelUrl: '/handpose-landmark/model.json' });
}
